...
type InputHookElement = HTMLInputElement|HTMLTextAreaElement|HTMLSelectElement
...
type InputHook = (initial?: InputHookValue) => [
  InputHookValue,
  InputHookBind,
  InputHookAction
]
...
export const useInput: InputHook = (initial) => {
  ...
  const onChange: InputHookOnChange = useCallback((e) => {
    set(e.target.value);
  }, [set])
